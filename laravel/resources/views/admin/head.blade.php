...
<body>
	...
	<div class="head">
		<div class="headL">
			<img class="headLogo" src="{{URL::asset('')}}style/img/headLogo.png" />
		</div>
		<div class="headR">
			<p class="p1">
				欢迎 <?php echo $_SESSION['user']; ?> 登陆！
			</p>
			<p class="p2">
				<a href="{{url('System/changepwd')}}" target='_parent' class="resetPWD">重置密码</a>&nbsp;&nbsp;<a
					href="{{url('System/tuichu')}}"  target='_parent'  class="goOut">退出</a>
			</p>
		</div>
