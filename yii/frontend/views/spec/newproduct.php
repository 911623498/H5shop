                ...
                <?php foreach($goods as $k=>$v) {?>
                    <li>
                        <div class="am-gallery-item">
                            <a href="<?php echo '?r=spec/goods_info&goods_id='.$v['goods_id']?>" class="">
                                <img src="style/images/test10.png"/>
                                <h3 class="am-gallery-title"><?= $v['goods_name'] ?></h3>
                                <div class="am-gallery-desc"><?= '￥'.$v['goods_price'] ?> <del><?= '￥'.$v['goods_rebate'] ?></del></div>
                            </a>
                        </div>
                    </li>
                <? } ?>
