...
<html>
	...
	<body>
	    ...
	    <ul class="safty">
	    	...
	    	<li>
	    		<a href="">
	    			<img src="style/images/moneysafty.png" width="40" />
	    			<i>设置支付密码</i>
	    			<span class="am-icon-angle-right"></span>
	    		</a>
	    	</li>
	    	<li>
	    		<a href="">
	    			<img src="style/images/moneytele.png" width="40" />
	    			<i>绑定手机号</i>
	    			<span class="am-icon-angle-right"></span>
	    			<i style="float: right; padding-right: 10px;">136****3128</i>
	    		</a>
	    		<p style="overflow: hidden;">若你的手机已修改或信用，请立即更换</p>
	    	</li>
	    </ul>
	</body>
</html>
